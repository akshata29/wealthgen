...
const NAV_GROUPS: NavGroup[] = [
  {
    label: 'Advisory',
    items: [{ to: '/clients', icon: Users, label: 'Clients & Portfolios' }],
  },
  {
    label: 'Commentary',
    items: [
      ...
      { to: '/review', icon: CheckSquare, label: 'Review & Approve' },
    ],
  },
  {
    label: 'Architecture',
  ...
  return (
    <aside className="flex flex-col w-60 min-h-screen bg-surface-100 border-r border-border shrink-0">
      <div className="flex items-center gap-3 px-5 h-16 border-b border-border">
        ...
        <div>
          <div className="text-sm font-semibold text-gray-100">WealthGen</div>
