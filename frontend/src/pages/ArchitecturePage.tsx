...
const SERVICES: ServiceCard[] = [
  ...
  { name: 'Microsoft Fabric Lakehouse', role: 'Reference dataset — clients, mandates, holdings, attribution, performance (Lakehouse Delta tables via SQL analytics endpoint / OneLake)', sdk: 'pyodbc + ODBC Driver 18', status: 'GA' },
